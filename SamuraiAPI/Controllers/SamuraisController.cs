...
namespace SamuraiAPI.Controllers
{
    ...
    {
        private readonly SamuraiAppDataContext _context;

        public SamuraisController(SamuraiAppDataContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Samurais.Include(x => x.Horse).ToListAsync();
        }
